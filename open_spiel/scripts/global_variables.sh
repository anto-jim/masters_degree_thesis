...
# CUDA LibTorch (cu126) for GPU AlphaZero training. Override in the shell before
# sourcing this file if you need a different build.
export OPEN_SPIEL_BUILD_WITH_LIBTORCH_DOWNLOAD_URL="https://download.pytorch.org/libtorch/cu126/libtorch-cxx11-abi-shared-with-deps-2.6.0%2Bcu126.zip"
